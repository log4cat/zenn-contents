...
URL内のスキームがhttpsのときだけ，WebブラウザからCookieが送出される。(R01h)

##### Expires属性

Cookieに指定された有効期間を過ぎると，Cookieが無効化される。(R01h)

##### HttpOnly属性

JavaScriptによるCookieの読出しが禁止される。(R01h)

##### Path属性

WebブラウザがアクセスするURL内のパスとCookieによって指定されたパスのプレフィックスが一致するとき，WebブラウザからCookieが送出される。(R01h)
